...
class HeadlinesDecodableTests: XCTestCase {
	...
	func testWarningsResponseIsDecodedCorrectly() throws {
		...
		XCTAssertEqual(newsFeed.headlines[0].updated, Date(timeIntervalSinceReferenceDate: TimeInterval(1448401928)))
		...
		XCTAssertEqual(newsFeed.headlines[8].updated, Date(timeIntervalSinceReferenceDate: TimeInterval(1546300000)))
